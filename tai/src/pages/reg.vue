<template>
  <div class="content">
    <uc-nav bg-color="transparent" :border-width="0" arrow="gray"></uc-nav>
    <h1></h1>
    <div class="login-box">
      <p class="lsolid"></p>
      <div class="login">
    ...
    <ul>
      <uc-input v-model="username"  label="账号"></uc-input>
      <uc-input v-model="password" type="password" label="密码"></uc-input>
      {{mess}}
    </ul>
    <div class="footbox">
      <uc-button @click="reg" style="margin-top:.23rem">注 册</uc-button>
...
<style scoped>
  ...
  .content h1{width:2.18rem;height:1.35rem; background:url(../assets/img/my_cz.png) no-repeat center 0; background-size:60%; margin:0 auto; margin-top:1.22rem;}
