...
<style scoped>
  ...
  .header h2{width:1rem;height:1rem; border-radius:50%; margin:0 auto; overflow: hidden;}
  .header h2 img{width:100%; }
  .header .user-box{width:1.3rem; font-size:0.22rem; color:#fff; margin:0 auto; margin-top:0.2rem;}
  .user-box a{color:#fff;}
  .header ul{ margin-top:0.4rem;}
  .header ul li{width:50%;height:0.7rem; float:left; color:#fff;}
  .header ul li span{height:0.37rem; line-height:0.37rem; text-align:center; display:block; font-size:0.22rem;}
  .header ul li p{ text-align:center; font-size:0.25rem;height:0.32rem; line-height:0.32rem; border-right:1px solid #fff;}
