...
<div class="content">
    ...
    <div class="footbox">
      <uc-button @click="login" style="margin-top:.23rem">登 录</uc-button>
...
<style scoped>
  ...
  .content h1{width:2.18rem;height:1.35rem; background:url(../assets/img/say.png) no-repeat center 0; background-size:60%;  margin:0 auto; margin-top:1.22rem;}
