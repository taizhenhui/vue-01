<template>
  <div class="foot-btn" >
    <ul>
			<router-link to="/home" tag="li" class="home" active-class="active"><a href="javascript:;"></a></router-link>
			<router-link to="/follow" tag="li" class="write" active-class="active"><a href="javascript:;"></a></router-link>
			<router-link to="/user" tag="li" class="my" active-class="active"><a href="javascript:;"></a></router-link>
    </ul>
  </div>
</template>
